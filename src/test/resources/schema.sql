create table book (book_id bigint generated by default as identity, author varchar(255), category_name varchar(255), cover varchar(255), description varchar(255), isbn varchar(255), pub_date varchar(255), publisher varchar(255), title varchar(255), readinglog_id bigint, primary key (book_id));
...
create table collection (collection_id bigint generated by default as identity, name varchar(255) not null, user_id bigint, primary key (collection_id));
create table reading_log (readinglog_id bigint generated by default as identity, note1 TEXT, note2 TEXT, note3 TEXT, rating integer, status enum ('FINISHED','NEW','READING','TO_READ'), user_id bigint, primary key (readinglog_id));
create table users (user_id bigint generated by default as identity, email varchar(255) not null, picture varchar(255) not null, role enum ('ADMIN','USER'), primary key (user_id));
